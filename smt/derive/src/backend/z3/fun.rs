...
// /// Processes the body and returns the SMT-LIB expression string.
// pub fn process_function_body_str(
//     ir: &IRContext,
//     fn_id: UsrFunId,
//     exp_registry: &ExpRegistry,
//     root_exp_id: ExpId,
//     ty_map: &HashMap<UsrSortId, String>,
//     cloak_manager: &mut CloakManager,
//     map_length_manager: &mut MapLengthManager,
//     axiomatic_parameters: &mut HashMap<String, String>, // Changed Dynamic to String
// ) -> String {
//     // Get the function signature
//     let sig = ir.fn_registry.retrieve_sig(fn_id);

//     // Generate parameter names string list for reference if needed,
//     // though process_expression likely handles lookup.
//     let param_vars: Vec<(Symbol, String)> = sig
//         .params
//         .iter()
//         .map(|(param_name, param_sort)| {
//             (
//                 param_name.clone(),
//                 param_name.to_string(), // In SMT string, the var is just its name
//             )
//         })
//         .collect();

//     // Process the expression tree to create SMT-LIB string
//     // NOTE: This assumes `process_expression` has been updated to return String
//     // and accept these types.
//     let body_str = process_expression(
//         exp_registry,
//         root_exp_id,
//         ir,
//         // fn_map is removed because in SMT strings we don't need Decl objects, just names
//         ty_map,
//         &param_vars,
//         cloak_manager,
//         map_length_manager,
