...
impl UsrFuncName {
    ...
    pub fn intrinsic(name: &str) -> Self {
        match name {
            ...
            // float
            | "add" | "sub" | "mul" | "div" | "neg" | "abs" | "rem" | "sqrt" | "min" | "max" | "is_nan" | "is_infinite" | "is_zero" | "is_normal" | "is_subnormal" | "is_negative" | "is_positive" | "lt" | "le" | "gt" | "ge" | "nan" | "infinity" | "neg_infinity" | "pos_zero" | "neg_zero" | "to_integer" | "to_real" | "to_u32" | "to_i32" | "to_i64" | "to_u64" | "ceil" | "floor" | "trunc" | "nearest" | "fp_eq"
            // Integer operations.
